...
def reply_whatsapp():
    ...
    #     "AC826e257352646b7b90683e8f767f209d", "238580627cb97ff3956fbf7f36df4d2d")
    from twilio.rest import Client

    tClient = Client("AC826e257352646b7b90683e8f767f209d",
                     "238580627cb97ff3956fbf7f36df4d2d")
    tClient.messages.create(to="whatsapp:+919503838135",
                            from_="whatsapp:+14155238886", body=bot_response)
    tClient.messages.create(
        body="Hello there!", from_="whatsapp:+17088157986", to="whatsapp:+919503838135")
    response = MessagingResponse()
    response.message(bot_response)
    print(bot_response)
    # print("Allok",response)
    return str(response)
